...
export function CourseCard({ title, description, price, imgUrl,courseId }) {
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button
            ...
            onClick={() => {
                BuyModalContext.setOpenBuyModal(!BuyModalContext.openBuyModal);
                BuyModalContext.setCourseId(courseId);
            }}
          >
            Buy
          </button>
